package com.example.lwhenyoucai.mysamplebbs.ChatUI.ui.activity;
...
import com.example.lwhenyoucai.mysamplebbs.ChatUI.adapter.ChatAdapter;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.adapter.CommonFragmentPagerAdapter;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.enity.FullImageInfo;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.enity.MessageInfo;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.ui.fragment.ChatEmotionFragment;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.ui.fragment.ChatFunctionFragment;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.util.Constants;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.util.GlobalOnItemClickManagerUtils;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.util.MediaManager;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.widget.EmotionInputDetector;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.widget.NoScrollViewPager;
import com.example.lwhenyoucai.mysamplebbs.ChatUI.widget.StateButton;
...
public class ChatMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chatui_main);
    ...
    private ChatAdapter.onItemClickListener itemClickListener = new ChatAdapter.onItemClickListener() {
        ...
        public void onHeaderClick(int position) {
            Toast.makeText(ChatMain.this, "onHeaderClick", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onImageClick(View view, int position) {
            ...
            startActivity(new Intent(ChatMain.this, FullImageActivity.class));
